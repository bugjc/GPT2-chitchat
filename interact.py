...
def set_args():
    ...
    parser.add_argument('--model_path', default='model/model_epoch40_50w', type=str, required=False,
                        help='对话模型路径')
...
def main_websocket():
    ...
    async def start_server():
        try:
            async with websockets.serve(server, "127.0.0.1", 7397):
                print("Starting server at ws://127.0.0.1:7397")
